...
switch(player.position) {
  case 'QB':
    return calculateRushingScore(player) + calculatePassingScore(player)
  case 'RB':
    return calculateReceivingScore(player) + calculateRushingScore(player) + calculateReturnScore(player)
  case 'WR':
    return calculateReceivingScore(player) + calculateRushingScore(player) + calculateReturnScore(player)
  case 'TE':
